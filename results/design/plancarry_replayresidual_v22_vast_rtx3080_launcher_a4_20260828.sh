...
PY
  ...
  "$PY" whitebox_bridge_prefixstable_proto.py --host 127.0.0.1 --port 8892 --disable-patch --model-id Qwen/Qwen3-1.7B --revision 70d244cc86ccca08cf5af4e1e306ecf908b1ad5e --device cuda --dtype bfloat16 --expected-device-substring 'NVIDIA GeForce RTX 3080' >"$TMP/bridge.log" 2>&1 &
